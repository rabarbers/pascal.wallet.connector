...
namespace Pascal.Wallet.Connector.Tests
{
    public class PascalConnectorUnitTests
    {
        ...
        public async Task AddNodeAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.AddNodeAsync("123.123.123.123:4004;7.7.7.7:4005");
        ...
        public async Task GetAccountAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetAccountAsync(296);
            Assert.Null(response.Error);
        ...
        public async Task GetWalletAccountsAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletAccountsAsync();
            Assert.Null(response.Error);
        ...
        public async Task GetWalletAccountsCountAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletAccountsCountAsync();
            Assert.Null(response.Error);
        ...
        public async Task GetWalletAccountsCountUsingEncodedKeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletAccountsCountAsync(encodedPublicKey: "CA022000662084946291B2620108EBD6A0653B742E3673529751FF6BB565D9F47D920ADA200005CDF25090FFFA9A72181D13E457C7CF061CCAF4D4618EBCF9EA1D124E39EDCB");
            Assert.Null(response.Error);
        ...
        public async Task GetWalletAccountsCountUsingB58KeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletAccountsCountAsync(b58PublicKey: "3Ghhbop8Mfdp8P7Ltuwu8nVpNXMAcEc8KSVWQ7ZgyHjYeHpBg8ezuKi1DJw5EoZYKhwbXqFLgb4YnfzJT3yQTupfVorNrtWdpqVEp8");
            Assert.Null(response.Error);
            Assert.Equal<uint>(2, response.Result);
        }
        ...
        public async Task GetWalletPublicKeysAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletPublicKeysAsync();
            Assert.Null(response.Error);
        ...
        public async Task GetPublicKeyUsingEncodedKeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletPublicKeyAsync(encodedPublicKey: "CA022000662084946291B2620108EBD6A0653B742E3673529751FF6BB565D9F47D920ADA200005CDF25090FFFA9A72181D13E457C7CF061CCAF4D4618EBCF9EA1D124E39EDCB");
            Assert.Null(response.Error);
        ...
        public async Task GetPublicKeyUsingB58KeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletPublicKeyAsync(b58PublicKey: "3Ghhbop8Mfdp8P7Ltuwu8nVpNXMAcEc8KSVWQ7ZgyHjYeHpBg8ezuKi1DJw5EoZYKhwbXqFLgb4YnfzJT3yQTupfVorNrtWdpqVEp8");
            Assert.Null(response.Error);
        ...
        public async Task GetWalletCoinsAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletCoinsAsync();
            Assert.Null(response.Error);
        ...
        public async Task GetWalletCoinsUsingEncodedKeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletCoinsAsync(encodedPublicKey: "CA022000662084946291B2620108EBD6A0653B742E3673529751FF6BB565D9F47D920ADA200005CDF25090FFFA9A72181D13E457C7CF061CCAF4D4618EBCF9EA1D124E39EDCB");
            Assert.Null(response.Error);
        ...
        public async Task GetWalletCoinsUsingB58KeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetWalletCoinsAsync(b58PublicKey: "3Ghhbop8Mfdp8P7Ltuwu8nVpNXMAcEc8KSVWQ7ZgyHjYeHpBg8ezuKi1DJw5EoZYKhwbXqFLgb4YnfzJT3yQTupfVorNrtWdpqVEp8");
            Assert.Null(response.Error);
            Assert.Equal(1500, response.Result);
        }
        ...
        public async Task GetBlockAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlockAsync(9781);
            Assert.Null(response.Error);
        ...
        public async Task GetBlocksLastAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlocksAsync(2);
            Assert.Null(response.Error);
        ...
        public async Task GetBlocksIntervalAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlocksAsync(9850, 9851);
            Assert.Null(response.Error);
        ...
        public async Task GetBlockCountAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlockCountAsync();
            Assert.Null(response.Error);
        ...
        public async Task GetBlockOperationNoPayloadAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlockOperationAsync(9781, 0);
            Assert.Null(response.Error);
        ...
        public async Task GetBlockOperationWithPayloadAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlockOperationAsync(10947, 0);
            Assert.Null(response.Error);
        ...
        public async Task GetBlockOperationWithPayloadAndPasswordAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlockOperationAsync(12239, 0);
            Assert.Null(response.Error);
        ...
        public async Task GetBlockOperationsAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetBlockOperationsAsync(12239);
            Assert.Null(response.Error);
        ...
        public async Task GetPendingsAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetPendingsAsync();
            Assert.Null(response.Error);
        ...
        public async Task GetPendingsUsingParametersAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetPendingsAsync(start: 1, max: 1);
            Assert.Null(response.Error);
        ...
        public async Task GetPendingsCountAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetPendingsCountAsync();
            Assert.Null(response.Error);
            Assert.Equal<uint>(2, response.Result);
        }
        ...
        public async Task FindOperationAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.FindOperationAsync("0000000063F5000001000000FCFA8E6D82F890C56248B2CF7FAB14FE947B16A5");
            Assert.Null(response.Error);
        ...
        public async Task FindAccountsAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.FindAccountsAsync(max: 2);
            Assert.Null(response.Error);
        ...
        public async Task SendToWithoutPayloadAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.SendToAsync(senderAccount: 38774, receiverAccount: 52, amount: 20, fee: 0);
            Assert.Null(response.Error);
        ...
        public async Task SendToWithPublicPayloadAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.SendToAsync(senderAccount: 38764, receiverAccount: 52, amount: 3, fee: 0, payload: "This is a payload!", payloadMethod: PayloadMethod.None);
            Assert.Null(response.Error);
        ...
        public async Task SendToWithDestinationEncryptedPayloadAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.SendToAsync(senderAccount: 38764, receiverAccount: 52, amount: 3, fee: 0, payload: "This is a payload!");
            Assert.Null(response.Error);
        ...
        public async Task SendToWithPasswordEncryptedPayloadAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.SendToAsync(senderAccount: 38764, receiverAccount: 52, amount: 3, fee: 0, payload: "This is a payload!", payloadMethod: PayloadMethod.Aes, password: "password");
            Assert.Null(response.Error);
        ...
        public async Task SendDataNoPayloadAsync()
        {
            ...
            var response = await client.SendDataAsync(senderAccount: 32459, receiverAccount: 52, guid: myguid.ToString());
            Assert.Null(response.Error);
        ...
        public async Task SendDataWithPayloadAmountFeeSequenceAsync()
        {
            ...
            var response = await client.SendDataAsync(senderAccount: 32459, receiverAccount: 52, guid: myguid.ToString(), payload: "This is payload!", amount: 3, fee: 2);
            Assert.Null(response.Error);
        ...
        public async Task SendDataWithDestinationEncryptedPayloadAsync()
        {
            ...
            var myguid = new Guid("C114F2AE-5BF5-470C-8071-4023CC9F4612");
            var response = await client.SendDataAsync(senderAccount: 32459, receiverAccount: 52, guid: myguid.ToString(), payload: "This is payload!", payloadMethod: PayloadMethod.Dest);
            Assert.Null(response.Error);
        ...
        public async Task SendDataWithAesEncryptedPayloadAsync()
        {
            ...
            var myguid = new Guid("C114F2AE-5BF5-470C-8071-4023CC9F4612");
            var response = await client.SendDataAsync(senderAccount: 32459, receiverAccount: 52, guid: myguid.ToString(), payload: "This is payload!", payloadMethod: PayloadMethod.Aes, password: "password");
            Assert.Null(response.Error);
        ...
        public async Task FindDataOperationsKnowingSenderReceiverGuidAsync()
        {
            ...
            var response = await client.FindDataOperationsAsync(senderAccount: 32459, receiverAccount: 52, guid: guid.ToString());
            Assert.Null(response.Error);
            Assert.Single(response.Result);
        ...
        public async Task FindDataOperationsKnowingSenderReceiverGuidDataTypeSequenceAsync()
        {
            ...
            var guid = new Guid("7244FE2E-0A87-4567-A472-72951D1B4F20");
            var response = await client.FindDataOperationsAsync(senderAccount: 32459, receiverAccount: 52, guid: guid.ToString(), dataType: DataType.PrivateMessage, dataSequence: 5);
            Assert.Null(response.Error);
            Assert.Single(response.Result);
        ...
        public async Task ChangeKeyUsingNewEncodedPublicKeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.ChangeKeyAsync(account: 38764, newEncodedPublicKey: "CA022000DC8EFC0C6A63B08BE93D4C8511052A4BE709DF728CCB5A047E29E921F76EA13B20003B77BAAE6461E66BEF8575CBB588C15982118B1AFD8DE0BF2753CEE4E760E167");
            Assert.Null(response.Error);
        ...
        public async Task ChangeKeyUsingNewB58PublicKeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.ChangeKeyAsync(account: 38764, newB58PublicKey: "3GhhbouLD4QsBCZbL3ozd6zBaQQYWgoHLPKLmrby5n4MgN6HknS2q825dVvZg6qJEFrikQdoiNbw5TsWJdYPZhCKTRomcSePRS7gE9");
            Assert.Null(response.Error);
        ...
        public async Task ChangeKeysUsingNewEncodedPublicKeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.ChangeKeysAsync(accounts: new uint[] { 43929, 43930 }, newEncodedPublicKey: "CA022000DC8EFC0C6A63B08BE93D4C8511052A4BE709DF728CCB5A047E29E921F76EA13B20003B77BAAE6461E66BEF8575CBB588C15982118B1AFD8DE0BF2753CEE4E760E167");
            Assert.Null(response.Error);
        ...
        public async Task ListAccountForSaleAsync()
        {
            ...
            var response = await client.ListAccountForSaleAsync(accountForSale: 32325, sellerAccount: 52, price: 20, signerAccount: 32325);
            Assert.Null(response.Error);
        ...
        public async Task DelistAccountForSaleAsync()
        {
            ...
            var response = await client.DelistAccountForSaleAsync(accountNumber: 32325, signerAccount: 32325);
            Assert.Null(response.Error);
        ...
        public async Task BuyAccountAsync()
        {
            ...
            var response = await client.BuyAccountAsync(buyerAccount: 52, accountToPurchase: 117842, amount: 1, newB58PublicKey: "3GhhbouLD4QsBCZbL3ozd6zBaQQYWgoHLPKLmrby5n4MgN6HknS2q825dVvZg6qJEFrikQdoiNbw5TsWJdYPZhCKTRomcSePRS7gE9");
            Assert.Null(response.Error);
        ...
        public async Task ChangeAccountInfoNameAsync()
        {
            ...
            var response = await client.ChangeAccountInfoAsync(accountTarget: 32320, signerAccount: 32320, newName: "newname");
            Assert.Null(response.Error);
        ...
        public async Task ChangeAccountInfoTypeAsync()
        {
            ...
            var response = await client.ChangeAccountInfoAsync(accountTarget: 32321, signerAccount: 32321, newType: 1);
            Assert.Null(response.Error);
        ...
        public async Task ChangeAccountInfoPublicKeyAsync()
        {
            ...
            var response = await client.ChangeAccountInfoAsync(accountTarget: 32321, signerAccount: 32321, newB58PublicKey: "3GhhbouLD4QsBCZbL3ozd6zBaQQYWgoHLPKLmrby5n4MgN6HknS2q825dVvZg6qJEFrikQdoiNbw5TsWJdYPZhCKTRomcSePRS7gE9");
            Assert.Null(response.Error);
        ...
        public async Task SignSendToAsync()
        {
            ...
            var response = await client.SignSendToAsync(senderAccount: 38764, receiverAccount: 52, amount: 1, lastNOperation: 7, fee: 0,
        ...
        public async Task SignDataUnencryptedAsync()
        {
            ...
            var response = await client.SignDataAsync(signerAccount: 32320, senderAccount: 32320, receiverAccount: 52, guid: "AAA19787-F847-4323-8987-2E652F593BCE", lastNOperation: 8, dataType: DataType.PrivateMessage,
        ...
        public async Task SignChangeKeyAsync()
        {
            ...
            var response = await client.SignChangeKeyAsync(account: 88888, lastNOperation: 0, oldB58PublicKey: "3Ghhbop8Mfdp8P7Ltuwu8nVpNXMAcEc8KSVWQ7ZgyHjYeHpBg8ezuKi1DJw5EoZYKhwbXqFLgb4YnfzJT3yQTupfVorNrtWdpqVEp8",
        ...
        public async Task SignListAccountForSaleAsync()
        {
            ...
            var response = await client.SignListAccountForSaleAsync(accountForSale: 117840, sellerAccount: 52, price: 20, lastNOperation: 5, signerAccount: 117840,
        ...
        public async Task SignDelistAccountForSaleAsync()
        {
            ...
            var response = await client.SignDelistAccountForSaleAsync(accountNumber: 117840, signerAccount: 117840, lastNOperation: 2,
                signerB58PublicKey: "3GhhbouLD4QsBCZbL3ozd6zBaQQYWgoHLPKLmrby5n4MgN6HknS2q825dVvZg6qJEFrikQdoiNbw5TsWJdYPZhCKTRomcSePRS7gE9");
        ...
        public async Task SignBuyAccountAsync()
        {
            ...
            var response = await client.SignBuyAccountAsync(buyerAccount: 52, accountToPurchase: 150000, sellerAccount: 32320, price: 1, amount: 1, lastNOperation: 348,
        ...
        public async Task SignChangeAccountInfoAsync()
        {
            ...
            var response = await client.SignChangeAccountInfoAsync(accountTarget: 32321, signerAccount: 32321, lastNOperation: 2, newName: "name",
                signerB58PublicKey: "3Ghhbop8Mfdp8P7Ltuwu8nVpNXMAcEc8KSVWQ7ZgyHjYeHpBg8ezuKi1DJw5EoZYKhwbXqFLgb4YnfzJT3yQTupfVorNrtWdpqVEp8");
        ...
        public async Task OperationsInfoAsync()
        {
            ...
            var response = await client.OperationsInfoAsync("0100000008000500417E0000417E00000A00000000000000000000000000000000000000000200000000000005006E616D653300000000200003AB5101A9B84B19B8AD4697D9CE92BD9BDFD3127C9F71C7C356B5D49DE324B92000EF5F290E79F972B76393E63A7E2D8D8C0FF1B7CA26F9847D14A4087327A38DE6");
        ...
        public async Task EncodePublicKeyAsync()
        {
            ...
            var response = await client.EncodePublicKeyAsync(EncryptionType.Secp256k1, "0E60B6F76778CFE8678E30369BA7B2C38D0EC93FC3F39E61468E29FEC39F13BF", "572EDE3C44CF00FF86AFF651474D53CCBDF86B953F1ECE5FB8FC7BB6FA16F114");
        ...
        public async Task DecodePublicKeyAsync()
        {
            ...
            var response = await client.DecodePublicKeyAsync(encodedPublicKey: "CA0220000E60B6F76778CFE8678E30369BA7B2C38D0EC93FC3F39E61468E29FEC39F13BF2000572EDE3C44CF00FF86AFF651474D53CCBDF86B953F1ECE5FB8FC7BB6FA16F114");
        ...
        public async Task PayloadEncryptUsingPasswordAsync()
        {
            ...
            var response = await client.PayloadEncryptAsync(payload: "DODO", method: AbstractPayloadMethod.Aes, password: "mypassword");
        ...
        public async Task PayloadEncryptUsingEncodedPublicKeyAsync()
        {
            ...
            var response = await client.PayloadEncryptAsync(payload: "DODO", method: AbstractPayloadMethod.PubKey, encodedPublicKey: "CA022000662084946291B2620108EBD6A0653B742E3673529751FF6BB565D9F47D920ADA200005CDF25090FFFA9A72181D13E457C7CF061CCAF4D4618EBCF9EA1D124E39EDCB");
        ...
        public async Task PayloadDecryptUsingPasswordAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.PayloadDecryptAsync("53616C7465645F5F8312C92E9BFFD6068ADA9F2F7CEA90505B50CE2CAE995C28", "mypassword");
        ...
        public async Task PayloadDecryptUsingWalletPrivateKeysAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.PayloadDecryptAsync("21100400100003E2978A4DD3A11B638BD2A31D404FA941A9C4CDA0FFAF90B601F50FC1777A0F80C5440FBCCC08FF121567467E4EB46BF6F7B54250E580E1CA01F8924069CC6219");
        ...
        public async Task GetConnectionsAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.GetConnectionsAsync();
        ...
        public async Task AddNewKeyAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.AddNewKeyAsync(EncryptionType.Secp256k1, "TestKey");
        ...
        public async Task UnlockAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.UnlockAsync("test");
        ...
        public async Task SetWalletPasswordAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.SetWalletPasswordAsync("test");
        ...
        public async Task StopNodeAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.StopNodeAsync();
        ...
        public async Task StartNodeAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.StartNodeAsync();
        ...
        public async Task SignMessageAsync()
        {
            ...
            using var client = new PascalConnector(new Uri("http://127.0.0.1:4003"), new HttpClient(handlerMock.Object));
            var response = await client.SignMessageAsync(digest: "Message", b58PublicKey: "3Ghhbop8Mfdp8P7Ltuwu8nVpNXMAcEc8KSVWQ7ZgyHjYeHpBg8ezuKi1DJw5EoZYKhwbXqFLgb4YnfzJT3yQTupfVorNrtWdpqVEp8");
        ...
        public async Task VerifySignedMessageAsync()
        {
            ...
            var response = await client.VerifySignedMessageAsync(digest: "Message", b58PublicKey: "3GhhborhTCvmruFryDD6kCnteRmFaYs8XTvsS47uwQLnWa85RLwTHZnHN3QMy2Y97wjSmcXhkpP98c8peXXqELJDMBvoW5K59AnvDP",
                signature: "20008448306B9549D798D873A10E6BA8BA101099C92B992903A835ED4A177C29848120000B34DB7160A776CB95F7AFF0BFA2EBAB4685B71ED9C63D6ECF922BE29D23A147");
        ...
        public async Task MultioperationAddOperationAsync()
        {
            ...
            var response = await client.MultioperationAddOperationAsync(senders: senders, receivers: receivers);
        ...
        public async Task MultiOperationSignOfflineAsync()
        {
            ...
            var response = await client.MultiOperationSignOfflineAsync(rawOperation, keys);
        ...
        public async Task MultioperationSignOnlineAsync()
        {
            ...
            var response = await client.MultioperationSignOnlineAsync("010000000900050005000200407E0000112700000000000020000000000500746573743100000000417E0000102700000000000014000000000500746573743200000000010034000000204E00000000000000050074657374330000");
        ...
        public async Task OperationsDeleteAsync()
        {
            ...
            var rawOperation = "010000000900050005000200407E0000112700000000000020000000000500746573743100000000417E0000102700000000000014000000000500746573743200000000010034000000204E00000000000000050074657374330000";
            var response = await client.OperationsDeleteAsync(rawOperation, 0);
